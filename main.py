...
def _news_scraper(news_site_uid):
    ...
    print('Scraping ready - All is OK')
...
def _fetch_article(news_site_uid, host, link):
    ...
    try:
        ...
        logger.warning('Errror while fetching the article', exc_info=False)
...
if __name__ == '__main__':
    ...
    # Datos de entrada - El usuario escoge el sitio que quiere scrapear
    # Estos datos estan almacenados en el archivo config.yaml
    # Y son leidos con el módulo common.py. 
    ...
    # Llamado a la funcion que trae los links de la web scrapeada
    # Recibe como argumento el sito seleccionado por el usuario
